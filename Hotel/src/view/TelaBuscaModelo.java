...
public class TelaBuscaModelo extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jComboBoxBusca.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "Descrição", "Marca", "Status" }));
        ...
        if (jTableDados.getColumnModel().getColumnCount() > 0) {
            ...
            jTableDados.getColumnModel().getColumn(2).setMaxWidth(280);
