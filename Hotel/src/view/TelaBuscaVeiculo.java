...
public class TelaBuscaVeiculo extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jComboBoxBusca.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "Placa", "Marca", "Modelo", "Cor", "Status" }));
        ...
        if (jTableDados.getColumnModel().getColumnCount() > 0) {
            ...
            jTableDados.getColumnModel().getColumn(2).setMaxWidth(125);
            jTableDados.getColumnModel().getColumn(3).setMaxWidth(115);
            jTableDados.getColumnModel().getColumn(4).setMaxWidth(100);
